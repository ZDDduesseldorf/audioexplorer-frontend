...
export function FilterSidebar() {
    ...
    const handleReset = () => {
        if (!showCategorized) toggleCategorized();
        if (!showUncategorized) toggleUncategorized();
        ...
        <aside className="filter-sidebar" aria-label="Filter sidebar">
            ...
            <section className="filter-section">
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "8px" }}>
                    <h3 className="filter-section-title" style={{ margin: 0 }}>Filter by Category</h3>
                    <div style={{ display: "flex", gap: "8px", fontSize: "0.75rem" }}>
                        <button
                            type="button"
                            onClick={handleSelectAll}
                            style={{ background: "transparent", border: "none", color: "#3498db", cursor: "pointer", padding: 0 }}
                        >
                            Select All
                        </button>
                        ...
                        <button
                            ...
                            style={{ background: "transparent", border: "none", color: "#e74c3c", cursor: "pointer", padding: 0 }}
                        >
                            Deselect All
                        </button>
                    </div>
            ...
            {/* 👇 دکمه‌ی Export که دقیقاً در انتهای سایدبار قرار گرفت */}
            <div style={{ padding: "16px", marginTop: "auto", borderTop: "1px solid rgba(143, 160, 216, 0.15)" }}>
                <ExportButton />
            </div>
        </aside>
    );
